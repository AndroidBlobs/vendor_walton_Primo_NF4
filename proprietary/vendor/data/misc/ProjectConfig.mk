...
MTK_BUILD_VERNO = alps-mp-o1.mp1-V1.141.2_k39tv1.bsp.1g_TMP1
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
###songyl@x-thinks.com add 20180901
CUSTOM_KERNEL_BAROMETER = no
CUSTOM_KERNEL_GYROSCOPE = no
CUSTOM_KERNEL_MAGNETOMETER = no
### camera porting, add by jint@x-thinks.com at 20180507 +++
CUSTOM_HAL_IMGSENSOR = imx219_mipi_raw ov8865_mipi_raw gc5025_mipi_raw gc5025f_mipi_raw
CUSTOM_HAL_LENS = dw9718saf dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = imx219_mipi_raw gc5025_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9718saf dw9714af
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = ov8865_mipi_raw gc5025f_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_IMGSENSOR = imx219_mipi_raw ov8865_mipi_raw gc5025_mipi_raw gc5025f_mipi_raw
CUSTOM_KERNEL_LENS = dw9718saf dw9714af dummy_lens
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx219_mipi_raw gc5025_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9718saf dw9714af
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS = 
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8865_mipi_raw gc5025f_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
#X-Thinks begin, for Trustkernel TEE add by lijiang 2018.9.19 11:08
MTK_TEE_SUPPORT = yes
TRUSTKERNEL_TEE_SUPPORT = yes
#X-Thinks end
#custom xthink build id,zhoum@x-thinks.com,2017.12.14
ifeq ($(FEATURE_XTHINK_CUSTOM_VERSION),true)
MTK_BUILD_VERNO=$(XTHINK_BUILD_VERSION)
endif
#X-Thinks end

#adupsfota start,meilq@x-thinks.com,2018.10.17
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=no
ADUPS_FOTA_WITHOUT_MENU=no
#adupsfota end,meilq@x-thinks.com,2018.10.17

#xthink add begain,add for project partition table by fengdongjie  2018.10.23
XTHINK_PRODUCT_PARTITION_TABLE = Primo_NF4
#xthink add end
